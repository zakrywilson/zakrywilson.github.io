...
public class View {
  ...
  /**
   * Initializes frame by creating components, 
   * creating the layout, and configuring the display.
   */
  private void init() {
    createComponents();
    createLayout();
  ...
  /**
   * Creates new button with the desired size and name.
   * @return the button
   */
  ...
  private void createLayout() {
    ...
    // See my Github page if you want to see the layout configuration.
  }
...
public class Controller {
  ...
  /**
   * Set up listeners: assign them to their respective components.
   */
  ...
  private void addShowButtonListener() {
    ...
    view.getShowButton().addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        // Now we can use this info in the model whenever we like
        String text = model.getText();
        String msg = (text.equals("")) ? "No content" : text;
